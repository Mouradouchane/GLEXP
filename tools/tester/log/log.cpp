...
const std::string result_file_name = "tester_results_";
...
namespace tester {
	...
	bool logger::save_tests_results_in_log_file(std::string const& results_as_str) {
		...
		std::string logs_folder_path = results_path;
		...
		std::string file_path = results_path + "/" + file_name;

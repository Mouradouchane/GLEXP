...
#ifndef CORE_MEMORY_HEAP_CPP
#define CORE_MEMORY_HEAP_CPP
...
core::memory::heap::heap(string const& heap_name, core::memory::tag memory_tag, u32 heap_size, u32 max_allocation) noexcept
...
inline void core::memory::heap::sort_list_by_address(registry_pair * list, u32 count) {
...
inline void core::memory::heap::sort_list_by_size(registry_pair * list, u32 count) {
...
inline void core::memory::heap::init_registry_list(registry_pair * list, u32 count) {
...
inline void core::memory::heap::find_free_location(u32 & index_output, u32 size__) {
...
inline void core::memory::heap::allocate_from_free_list(void** pointer, u32 size__, u32 index) {
...
// todo: i think we have BUG here
u32 core::memory::heap::hash_pointer(void* pointer) {
	return (u64)pointer % this->alloc_list_size;
}

inline void core::memory::heap::register_allocation(void* pointer, u32 count) {
	...
	CRASH_IF(1, "memory_register_allocation : allocation registry is full no place found for new insert !");
}

inline void core::memory::heap::unregister_allocation(u32 _index) {
	DEBUG_BREAK;
...
void core::memory::heap::merge_free_areas() {
...
u32 core::memory::heap::size() noexcept {
	return this->_size_;
}

u32 core::memory::heap::allocated() noexcept {
	return this->alloc_size;
}

u32 core::memory::heap::available() noexcept {

...
#define INSTANTIATE_EVENT_SYSTEM_FUNCTION_FOR(TYPE) \
		extern template listener_id start_listening<TYPE>(listener_function<TYPE>) noexcept; \
...
MAP_DATATYPE_TO_EVENT(event_type::unkown, unkown_data);

// mouse-events mapping
MAP_DATATYPE_TO_EVENT(event_type::mouse_click_left, mouse_data);
MAP_DATATYPE_TO_EVENT(event_type::mouse_click_right, mouse_data);
MAP_DATATYPE_TO_EVENT(event_type::mouse_scroll, mouse_data);

// keyboard-events mapping
MAP_DATATYPE_TO_EVENT(event_type::keypress_up, keyboard_data);
MAP_DATATYPE_TO_EVENT(event_type::keypress_down, keyboard_data);

// window-events mapping
MAP_DATATYPE_TO_EVENT(event_type::window_open, window_data);
MAP_DATATYPE_TO_EVENT(event_type::window_close, window_data);
MAP_DATATYPE_TO_EVENT(event_type::window_resize, window_data);
...
namespace core {
	...
	namespace mouse_event {
		...
		typedef core::event<event_type::mouse_scroll>      mouse_scroll;
	}

	namespace keyboard_event {
		typedef core::event<event_type::keypress_up>   keypress_up;
		typedef core::event<event_type::keypress_down> keypress_down;
	}
	...
	namespace listener {
		typedef listener_function<event_type::unkown> unkown_event;

		typedef listener_function<event_type::mouse_click_left>  mouse_left_click;
		typedef listener_function<event_type::mouse_click_right> mouse_right_click;
		typedef listener_function<event_type::mouse_scroll>      mouse_scroll;
		
		typedef listener_function<event_type::keypress_up>   keypress_up;
		typedef listener_function<event_type::keypress_down> keypress_down;

		typedef listener_function<event_type::window_open>   window_open;
		typedef listener_function<event_type::window_close>  window_close;
		typedef listener_function<event_type::window_resize> window_resize;
	}
	...
	*/ 
	namespace event_system { 
		...
		template<event_type etype> 
		DLL_API listener_id start_listening(core::listener_function<etype> listener_function) noexcept;
		...
		*/
		INSTANTIATE_EVENT_SYSTEM_FUNCTION_FOR(event_type::unkown);
		// window events
		INSTANTIATE_EVENT_SYSTEM_FUNCTION_FOR(event_type::window_open);
		INSTANTIATE_EVENT_SYSTEM_FUNCTION_FOR(event_type::window_resize);
		INSTANTIATE_EVENT_SYSTEM_FUNCTION_FOR(event_type::window_close);
		// mouse events
		INSTANTIATE_EVENT_SYSTEM_FUNCTION_FOR(event_type::mouse_click_left);
		INSTANTIATE_EVENT_SYSTEM_FUNCTION_FOR(event_type::mouse_click_right);
		INSTANTIATE_EVENT_SYSTEM_FUNCTION_FOR(event_type::mouse_scroll);
		// keyboard events
		INSTANTIATE_EVENT_SYSTEM_FUNCTION_FOR(event_type::keypress_up);
		INSTANTIATE_EVENT_SYSTEM_FUNCTION_FOR(event_type::keypress_down);
